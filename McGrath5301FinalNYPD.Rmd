...
ggplot(shootings_by_year, aes(x = year, y = total_shootings)) +
  ...
  theme_light()
```
Adding a linear regression model to the data shows an overall downward trend in police shooting incidents. The model has limitations. The major spike in 2020 does not fit the model, nor does the more rapid decline from 2011 to 2019.
